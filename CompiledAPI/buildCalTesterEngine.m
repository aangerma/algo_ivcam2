function res = buildCalTesterEngine(isCopyToPrebuild)
    ...
    Files = { 'cal_init.m' ,'IR_DelayCalibCalc' ,'Z_DelayCalibCalc' ,'DSM_CoarseCalib_Calc.m' ,'Version.m' ,'DSM_Calib_Calc.m' , 'DFZ_Calib_Calc.m' ,'ROI_Calib_Calc.m', 'END_calib_Calc.m', 'RGB_Calib_Calc.m'};
