function [udistLUT,undistx,undisty]=generateUndistTablesFromGridPointsOnly(regs,undistTpsModel)
% (To add) 2D Undist - 
...
v = Calibration.Undist.undistByTPSModel( v',undistTpsModel)';% 2D Undist - 
