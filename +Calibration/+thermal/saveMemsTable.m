...
% VSense estimation model (R in KOhm): vsenseEstSlope*(R-vsenseEstRefRes)
...
bytesVec(73:76)     = typecast(results.pzr(1).vsenseEstSlope, 'uint8');
bytesVec(77:80)     = typecast(results.pzr(2).vsenseEstSlope, 'uint8');
bytesVec(81:84)     = typecast(results.pzr(3).vsenseEstSlope, 'uint8');
bytesVec(85:88)     = typecast(results.pzr(1).vsenseEstRefRes, 'uint8');
bytesVec(89:92)     = typecast(results.pzr(2).vsenseEstRefRes, 'uint8');
bytesVec(93:96)     = typecast(results.pzr(3).vsenseEstRefRes, 'uint8');
