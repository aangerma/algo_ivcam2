...
rangeR = rotmat*rotmat*xyz2nrmxy(applyFOVex(oXYZfunc(angles2xyz( regs.FRMW.xfov(1)*0.25,                   0))));rangeR=rangeR(1);
rangeL = rotmat*rotmat*xyz2nrmxy(applyFOVex(oXYZfunc(angles2xyz(-regs.FRMW.xfov(1)*0.25,                   0))));rangeL=rangeL(1);
rangeT = rotmat*rotmat*xyz2nrmxy(applyFOVex(oXYZfunc(angles2xyz(0                   , regs.FRMW.yfov(1)*0.25))));rangeT =rangeT (2);
rangeB = rotmat*rotmat*xyz2nrmxy(applyFOVex(oXYZfunc(angles2xyz(0                   ,-regs.FRMW.yfov(1)*0.25))));rangeB=rangeB(2);
