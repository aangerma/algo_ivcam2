...
cam.Stream.ConfigureAndPlay(new CameraConfiguration(
    new List<StreamConfigurationWrapper>
            {
                new StreamConfigurationWrapper(CompositeDeviceType.Depth, new StreamConfiguration(IVCam20DepthMode.Z.ToString(), eImageResolution.ir480x640, 30)),
                new StreamConfigurationWrapper(CompositeDeviceType.Depth, new StreamConfiguration(IVCam20DepthMode.I.ToString(), eImageResolution.ir480x640, 30)),
                new StreamConfigurationWrapper(CompositeDeviceType.Depth, new StreamConfiguration(IVCam20DepthMode.C.ToString(), eImageResolution.ir240x640, 30))
                 }));
            }
));
%}
