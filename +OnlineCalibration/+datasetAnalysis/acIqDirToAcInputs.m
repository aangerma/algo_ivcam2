...
frame_ir = fullfile(scene_data_folder,'ir.raw');
frame_depth = fullfile(scene_data_folder,'depth.raw');
frame_color = fullfile(scene_data_folder,'rgb.raw');
frame_color_prev = fullfile(scene_data_folder,'rgb_prev.raw');
