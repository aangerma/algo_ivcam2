...
% x = [Fisheye.Extrinsics.Rodrigues2(Tinit(1:3,1:3))', Tinit(1:3,4)']';     
...
%     [r, J] = Fisheye.Extrinsics.residualsAndJacobian(x, rnull, snull, points3D);
    % design matrix
    N = J.'*invKll*J;
    % System matrix
    g = J.'*invKll*r;
...
% Tout = [Fisheye.Extrinsics.Rodrigues2(x(1:3)) x(4:6)];
