...
doEval = false;
calibParams.dfz.doCroppedAreaInCalibDFZ = 0;
[~,resultsDFZcroppedTpsNdfzFull,allVerticesDFZcroppedTpsNdfzFull] = Calibration.aux.calibDFZ(d(imIx),regsWithDFZres,calibParams,fprintff,0,doEval,[],runParams,tpsUndistModel_vFullFromEval);
