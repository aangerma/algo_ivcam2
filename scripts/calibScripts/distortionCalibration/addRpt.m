function [ darr ] = addRpt( darr,regs )
    ...
    for i = 1:numel(darr)
        ...
        [p,bsz] = Calibration.aux.CBTools.findCheckerboard(normByMax(double(darr(i).i)), []); % p - 3 checkerboard points. bsz - checkerboard dimensions.
        if isempty(p)
