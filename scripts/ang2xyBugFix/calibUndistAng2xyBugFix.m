...
% Apply the lut to the bugged x-y and calculate the theoretical displacement error:
...
% Optional - Get a CB image before and after the undist and see that the
% new location of the corners is indeed fixed.
