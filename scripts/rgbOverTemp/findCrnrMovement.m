basePath = 'S:\IVCAM\L515\Calibration\BIG PBS\HENG-2693';%'X:\Users\mkiperwa\algo2ValWrgb';
unitNumber = {'F9340026\Avishayexperiment\Algo2 3.08.0 10C Self Heating';'F9340026\Avishayexperiment\Algo2 3.08.0 10C Thermo';...
    'F9340026\Avishayexperiment\Algo2 3.08.0 25C Thermo';'F9340026\Avishayexperiment\Algo2 3.08.0 Self Heating'};%{'F9340021';'F9340203'; 'F9340255'};
...
%     errVec = nan(numel(tempRngVec)-2,1);
    ...
    title({['Unit ' regexprep(unitNumber{ixUnit},'\',' ')],['Y RMSE compared to reference temperature: [' num2str(referTempRng(1)) ',' num2str(referTempRng(2)) '] , grouping every ' num2str(tempDiff) ' degree']});
    ...
    title({['Unit ' regexprep(unitNumber{ixUnit},'\',' ')],['X max absolute error compared to reference temperature: [' num2str(referTempRng(1)) ',' num2str(referTempRng(2)) '] ,  grouping every ' num2str(tempDiff) ' degree']});
    ...
    title({['Unit ' regexprep(unitNumber{ixUnit},'\',' ')],['Y max absolute error compared to reference temperature: [' num2str(referTempRng(1)) ',' num2str(referTempRng(2)) '] ,  grouping every ' num2str(tempDiff) ' degree']});
    ...
    title({['Unit ' regexprep(unitNumber{ixUnit},'\',' ')],['X mean absolute error compared to reference temperature: [' num2str(referTempRng(1)) ',' num2str(referTempRng(2)) '] ,  grouping every ' num2str(tempDiff) ' degree']});
    ...
    title({['Unit ' regexprep(unitNumber{ixUnit},'\',' ')],['Y mean absolute error compared to reference temperature: [' num2str(referTempRng(1)) ',' num2str(referTempRng(2)) '] ,  grouping every ' num2str(tempDiff) ' degree']});
