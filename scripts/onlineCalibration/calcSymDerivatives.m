...
%%
dXout_dXin = dXout_dX3*dX3_dX2*dX2_dX1*dX1_dXin;
dYout_dYin = dYout_dY3*dY3_dY2*dY2_dY1*dY1_dYin;

dXout_dYin = dXout_dX3*dX3_dX2*dX2_dY1*dY1_dYin;
dYout_dXin = dYout_dY3*dY3_dY2*dY2_dX1*dX1_dXin;
