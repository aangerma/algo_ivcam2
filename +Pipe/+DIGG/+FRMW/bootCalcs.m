...
autogenRegs.DIGG.sphericalScale=int16(round(double([regs.GNRL.imgHsize regs.GNRL.imgVsize]).*alpha));
autogenRegs.DIGG.sphericalOffset=int16(round([double(regs.GNRL.imgHsize)/2 double(regs.GNRL.imgVsize)/2].*[4 1]));
