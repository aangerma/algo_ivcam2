...
[autogenRegs] = calcWeightsNnorms(regs,autogenRegs);

%=======================================NN act func=======================================

[autogenRegs] = calcNNactFunc(regs,autogenRegs);

%=======================================JFIL - shading=======================================

[autogenRegs] = calcShading(regs,autogenRegs);

%=======================================JFIL - gamma LUT=======================================

[autogenRegs] = calcGammaLUT(regs,autogenRegs);
...
function [autogenRegs] = calcWeightsNnorms(regs,autogenRegs)
...
function [autogenRegs] = calcNNactFunc(regs,autogenRegs)  % Move to pre-calc???
t=-1:2/6:1;
...
function [autogenRegs] = calcShading(regs,autogenRegs) 
[yg,xg]=ndgrid(0:16);
...
function [autogenRegs] = calcGammaLUT(regs,autogenRegs) 
X = linspace(0,1,65);
