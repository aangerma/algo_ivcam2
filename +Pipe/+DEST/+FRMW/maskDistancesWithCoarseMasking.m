function [autogenRegs ] = maskDistancesWithCoarseMasking(regs,autogenRegs)
...
delays = regs.DEST.txFRQpd(1) - regs.FRMW.algoThermalLoopOffset;
minRange =single(regs.FRMW.coarseMaskingMin);
maxRange = single(regs.FRMW.coarseMaskingMax);
...
autogenRegs.DCOR.coarseMasking = logical(DCORcoarseMasking);
end
