// *****************************************************************************
// *****************************************************************************
// cynw_non_blocking_get_initiator.h
//
// This file contains the definition of never-block get initiator. 
// These initiators always return immediatly when calling nb_get(). 
...
#ifndef CYNW_NON_BLOCKING_GET_INITIATOR_H
#define CYNW_NON_BLOCKING_GET_INITIATOR_H
...
struct nb_get_initiator_imp<T,TRAITS,0> 
    : sc_module
    , sc_interface
{
    HLS_METAPORT;

    nb_get_initiator_imp(sc_module_name);
    ...
    sc_port<cynw_tlm::tlm_nonblocking_get_if<T> > p;
};
...
// *****************************************************************************
template<typename T, typename TRAITS>
struct nb_get_initiator_imp<T,TRAITS,1> 
    : sc_module
    , sc_interface
    , cynw_get_port_base<T>
{
    ...
    typedef nb_get_initiator_imp<T, TRAITS, 1> this_type;
...
struct nb_get_initiator : nb_get_initiator_imp<T,TRAITS,TRAITS::Level> {
    nb_get_initiator(sc_module_name n = sc_gen_unique_name("nb_get_initiator")) 
...
// ---------------------------------------------------------------------------
// Internal method definitions for nb_get_initiator_imp (TLM)

template <typename T, typename TRAITS>
inline
nb_get_initiator_imp<T,TRAITS,0>::nb_get_initiator_imp(sc_module_name n) 
    : sc_module(n)
    , p("p")
{ }
...
template<typename CHAN>
inline void 
nb_get_initiator_imp<T,TRAITS,0>::operator()(CHAN& chan) { 
    p.bind(chan); 
}
...
template<typename CHAN>
inline void 
nb_get_initiator_imp<T,TRAITS,0>::bind(CHAN& chan) {
    operator()(chan);
}
...
template<typename CLK, typename RST>
inline void 
nb_get_initiator_imp<T,TRAITS,0>::clk_rst(CLK&, RST&) { }


template <typename T, typename TRAITS>
inline bool
nb_get_initiator_imp<T,TRAITS,0>::nb_get(T& v) {
...
template <typename T, typename TRAITS>
inline bool 
nb_get_initiator_imp<T,TRAITS,0>::nb_can_get(cynw_tlm::tlm_tag<T>* t) const {
...
nb_get_initiator_imp<T,TRAITS,0>::ok_to_get(cynw_tlm::tlm_tag<T>* t) const {
...
template <typename T, typename TRAITS>
inline void 
nb_get_initiator_imp<T,TRAITS,0>::reset_get(cynw_tlm::tlm_tag<T>* t) { 
...
template <typename T, typename TRAITS>
inline void
nb_get_initiator_imp<T,TRAITS,0>::reset() {
    reset_get();
}


// ---------------------------------------------------------------------------
// Internal method definitions for nb_get_initiator_imp (signal-level)

template <typename T, typename TRAITS>
inline
nb_get_initiator_imp<T,TRAITS,1>::nb_get_initiator_imp(sc_module_name n)
    : sc_module(n)
    , clk("clk")
    , rst("rst")
//    , valid("valid")
...
template<typename CHAN>
inline void 
nb_get_initiator_imp<T,TRAITS,1>::operator()(CHAN& chan) {
...
template<typename CHAN>
inline void 
nb_get_initiator_imp<T,TRAITS,1>::bind(CHAN& chan) {
    operator()(chan);
}
...
template<typename CLK, typename RST>
inline void 
nb_get_initiator_imp<T,TRAITS,1>::clk_rst(CLK& clk_in, RST& rst_in) {
    clk(clk_in);
    rst(rst_in);
}
...
template<typename T, typename TRAITS>
inline bool 
nb_get_initiator_imp<T,TRAITS,1>::nb_get(T &v) {
    FLEX_CHANNELS_RESET_CHECK;
    FLEX_CHANNELS_PROTOCOL(NB_GET_START) ;
    bool result; // Changed
    { HLS_DEFINE_PROTOCOL("NB_GET_PROTOCOL"); // Added
    ...
    } // End of HLS_DEFINE_PROTOCOL("NB_GET_PROTOCOL")
...
template<typename T, typename TRAITS>
inline bool 
nb_get_initiator_imp<T,TRAITS,1>::nb_can_get(cynw_tlm::tlm_tag<T>* t) const {
    FLEX_CHANNELS_RESET_CHECK;
    if (TRAITS::Allow_Multiple_Calls_Per_Cycle) {
        if (multi_calls_in_cycle_var != multi_calls_in_cycle_sig) {
            return false;
...
template<typename T, typename TRAITS>
inline const sc_event&
nb_get_initiator_imp<T,TRAITS,1>::ok_to_get(cynw_tlm::tlm_tag<T>* t) const {
...
template<typename T, typename TRAITS>
inline void 
nb_get_initiator_imp<T,TRAITS,1>::reset_get(cynw_tlm::tlm_tag<T>* t) {
...
template <typename T, typename TRAITS>
inline void
nb_get_initiator_imp<T,TRAITS,1>::reset() {
    reset_get();
}
