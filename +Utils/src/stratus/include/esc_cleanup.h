...
#ifndef ESC_CLEANUP_HEADER_GUARD__
#define ESC_CLEANUP_HEADER_GUARD__

/*!
  \file esc_cleanup.h
  \brief This file defines esc_cleanup() if it is not defined by the user
*/

//! Only used if not defined in user example
extern void esc_cleanup();

#endif // ESC_CLEANUP_HEADER_GUARD__
