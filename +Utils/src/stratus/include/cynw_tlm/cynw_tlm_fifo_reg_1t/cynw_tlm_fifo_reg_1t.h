...
// ****************************************************************************
// ctos_tlm_fifo_reg_1t.h
//
// This file contains the synthesizable version of tlm_fifo_reg_1t
//
// 
// ****************************************************************************

#ifndef CYNW_TLM_FIFO_REG_1T_HEADER
#define CYNW_TLM_FIFO_REG_1T_HEADER
...
namespace cynw_tlm
{
// Class tlm_fifo_reg_1t. 
// 
// This is a synthesizable version of tlm_fifo, to be implemented using discrete
// registers instead of a RAM. It allows only 1 put and 1 get per delta cycle.
//
...
public:
  typedef tlm_fifo_1t_control<SIZE> CONTROL;
    ...
    // constructors
    explicit tlm_fifo_reg_1t(sc_module_name nm = sc_gen_unique_name("tlm_fifo_reg_1t"))
...
#include "../cynw_tlm_utils/cynw_tlm_fifo_trace_apis.inc"
  ...
  private:
    // disabled
    tlm_fifo_reg_1t( const tlm_fifo_reg_1t& );
    tlm_fifo_reg_1t& operator = ( const tlm_fifo_reg_1t& );
...
inline 
void
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::reset_put(tlm_tag<T> *t) 
{
    CONTROL::_reset_w();
    if (RESET_DATA) {
	for (int i = 0; i < SIZE; ++i) {
        HLS_UNROLL_LOOP( ON, "CYNW_TLM_FIFO_UNROLL_RESET_DATA_LOOP_3");
	    m_buf[i].write(T());
	}
    }
#if !defined(STRATUS) && defined(NC_SYSTEMC)
...
inline 
void
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::reset_get(tlm_tag<T> *t) 
{
    CONTROL::_reset_r();
#if !defined(STRATUS) && defined(NC_SYSTEMC)
...
template< typename T, int SIZE, bool RESET_DATA>
int
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::size() const
{
    return SIZE;
}
...
template< typename T, int SIZE, bool RESET_DATA>
void
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::debug() const
{
...
template< typename T, int SIZE, bool RESET_DATA>
int
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::used() const
{
...
inline 
const T&
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::internal_datum(int ind) const
{
...
template< typename T, int SIZE, bool RESET_DATA>
bool
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::nb_peek(T& val, int n) const
{
    not_supported();
    return false;
}
...
template< typename T, int SIZE, bool RESET_DATA>
bool
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::nb_poke(const T& val, int n)
{
    not_supported();
    return false;
}
...
template< typename T, int SIZE, bool RESET_DATA>
const sc_event&
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::ok_to_get( tlm_tag<T> *t ) const
{
    not_supported();
    return *(new sc_event);
}
...
template< typename T, int SIZE, bool RESET_DATA>
const sc_event&
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::ok_to_peek( tlm_tag<T> *t ) const
{
    not_supported();
    return *(new sc_event);
}
...
template< typename T, int SIZE, bool RESET_DATA>
const sc_event&
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::ok_to_put( tlm_tag<T> *t ) const
{
    not_supported();
    return *(new sc_event);
}
...
template< typename T, int SIZE, bool RESET_DATA>
void
tlm_fifo_reg_1t<T,SIZE,RESET_DATA>::not_supported() const
{
#if !defined(STRATUS)
...
#include "../cynw_tlm_fifo_reg_1t/cynw_tlm_fifo_reg_1t_put_get.h"
#include "../cynw_tlm_fifo_reg_1t/cynw_tlm_fifo_reg_1t_peek.h"
